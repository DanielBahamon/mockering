class MocksController < ApplicationController
	...
	def index
		...
		@mocks_whatever = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, category: 0, unlist: false).limit(8)
		@mocks_knowledge = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 1).limit(8)
		@mocks_paranormal = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 2).limit(8)
		@mocks_short = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 3).limit(8)
		@mocks_event = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 4).limit(8)
		@mocks_aliens = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 5).limit(8)
		@mocks_animation = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 6).limit(8)
		@mocks_videoclip = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 7).limit(8)
		@mocks_podcast = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 8).limit(8)
		@mocks_reaction = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 9).limit(8)
		@mocks_protest = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 10).limit(8)
		@mocks_health = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 11).limit(8)
		@mocks_history = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 12).limit(8)
		@mocks_tutorial = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 13).limit(8)
		@mocks_training = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 14).limit(8)
		@mocks_tribute = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 15).limit(8)
		@mocks_report = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 16).limit(8)
		@mocks_music = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 17).limit(8)
		@mocks_nature = Mock.all.order("RANDOM() and mocks.created_at >= '#{1.week.ago}'").where(privated: false, reported: false, unlist: false, category: 18).limit(8)
	end
