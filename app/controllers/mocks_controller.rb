class MocksController < ApplicationController
	...
	def index
		...
		@mocks_aliens = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 4).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_animation = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 5).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_videoclip = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 6).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_podcast = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 7).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_reaction = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 8).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_protest = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 9).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_health = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 10).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_history = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 11).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_tutorial = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 12).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_training = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 13).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_tribute = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 14).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_report = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 15).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
		@mocks_music = Mock.all.order("created_at DESC").where(privated: false, reported: false, unlist: false, category: 16).limit(8).where("mocks.created_at >= '#{1.week.ago}'")
