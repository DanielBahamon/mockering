json.array! @notifications do |notification|
	...
	if notification.action == "followed"
		...
		json.notifiable do # notification.notifiable
			json.type " <p class='m-0 _text_notification'> has been commented on your video.</p> <i class='fas fa-comment _icon_notification'></i>"
			"Mocks"
		end
	elsif notification.action == "mentioned"
		json.notifiable do # notification.notifiable
			json.type " <p class='m-0 _text_notification'> has been mentioned in some video.</p> <i class='fas fa-at _icon_notification _2'></i>"
			"Mocks"
		end
		...
		json.notifiable do # notification.notifiable
			json.type " <p class='m-0 _text_notification'> has been posted a new video.</p> <i class='fas fa-video _icon_notification'></i>"
			"Mocks"
		end
	end
